<template>
  <div
    ...
    <div class="mx-datepicker-popup"
      ...
      <slot name="footer" :confirm="confirmDate" :isconfirm="confirm" :confirmText="confirmText">
...
import { isValidDate, isValidRange, isDateObejct, isPlainObject, formatDate, parseDate, throttle } from './utils/index.js'
